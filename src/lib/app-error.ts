...
export const ERROR_CODES = [
  ...
  "manage.companyRequired",
  "manage.employeeNotFound",
  "manage.employeeDuplicate",
  "manage.salaryProfileAmountInvalid",
  "manage.salaryProfileNetMismatch",
  "manage.salaryProfileNotFound",
  "manage.accountNotFound",
  ...
  "imports.ownerTransferDispositionOnly",
  "imports.reviewDispositionRequired",
  "imports.linkTransactionNotFound",
  "imports.linkTransactionWrongEntity",
  "imports.linkTransactionDeleted",
  "imports.linkTransactionAlreadyLinked",
  "imports.linkTransactionMismatch",
  "imports.linkIdentityAlreadyClaimed",
  "imports.rowNotManuallyLinked",
  "imports.linkedTransactionNeedsUnlink",
  ...
  "revolut.batchNotBooked",
  "revolut.batchReversalTopologyChanged",
  "revolut.batchOutsideConsumption",
  "revolut.batchOutsideSplitDependency",
  "revolut.rowNotFound",
  "revolut.rowLocked",
